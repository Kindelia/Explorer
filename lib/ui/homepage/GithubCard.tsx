...
export const GithubCard: FC<GithubCardProps> = (repo) => (
  <a
    ...
    target="_blank"
    rel="noreferrer"
    className="flex flex-col justify-center items-star t border-1 border-black rounded-lg p-4 h-full text-gray-600 w-56 space-y-2"
  >
    <div className="flex flex-row space-x-3 items-center">
      <FontAwesomeIcon icon={faBook} />
      <div className="mt-0 text-black font-bold text-lg">{repo.full_name}</div>
    </div>
